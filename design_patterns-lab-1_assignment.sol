...
// Setting the variable 'owner' to the address of the contract deployer. 
    ...
    modifier checkMarksRange(uint mark){
        require(mark > 0 && mark <= 100, "Marks is out of Range");
        _;
    } 
    ...
    function adding_values(address _address, string memory _name, string memory _subject, uint8 _mark) public checkMarksRange(_mark) { 
